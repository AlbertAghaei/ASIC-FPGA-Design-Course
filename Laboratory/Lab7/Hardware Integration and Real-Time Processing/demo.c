...
#define SOBL_VDMA_ID  XPAR_AXIVDMA_2_DEVICE_ID

#define S2MM_INTID XPAR_FABRIC_AXI_VDMA_1_S2MM_INTROUT_INTR
#define S2MM_INTID_sobel XPAR_FABRIC_AXI_VDMA_2_S2MM_INTROUT_INTR
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
   GpioSetup(&XScuGicInstance, MIO_0_ID, KEY_INTR_ID, &GpioInstance) ;
   xil_printf("vdma_write_init_before\n");
/* Initial Sobel Vdma */
   vdma_write_init(SOBL_VDMA_ID, &sobel_vdma, 1280 * 3, 720, DEMO_STRIDE, (unsigned int)pFrames[0], DISPLAY_NUM_FRAMES);
   Status1 = vdma_write_init(SOBL_VDMA_ID, &sobel_vdma, 1280 * 3, 720, DEMO_STRIDE, (unsigned int)pFrames[0], DISPLAY_NUM_FRAMES);
   if(Status1 == XST_FAILURE)
    xil_printf("narges1\n");
   xil_printf("vdma_write_init_after\n");

/* Set General Callback for Sensor Vdma */
xil_printf("XAxiVdma_SetCallBack_before\n");
XAxiVdma_SetCallBack(&sobel_vdma, XAXIVDMA_HANDLER_GENERAL,WriteCallBack, (void *)&sobel_vdma, XAXIVDMA_WRITE);
Status1 = XAxiVdma_SetCallBack(&sobel_vdma, XAXIVDMA_HANDLER_GENERAL,WriteCallBack, (void *)&sobel_vdma, XAXIVDMA_WRITE);
   if(Status1 == XST_FAILURE)
    xil_printf("narges4\n");
xil_printf("XAxiVdma_SetCallBack_after\n");
/* Set Error Callback for Sensor Vdma */
XAxiVdma_SetCallBack(&sobel_vdma, XAXIVDMA_HANDLER_ERROR,WriteErrorCallBack, (void *)&sobel_vdma, XAXIVDMA_WRITE);
Status1 = XAxiVdma_SetCallBack(&sobel_vdma, XAXIVDMA_HANDLER_ERROR,WriteErrorCallBack, (void *)&sobel_vdma, XAXIVDMA_WRITE);
   if(Status1 == XST_FAILURE)
    xil_printf("narges3\n");
xil_printf("XAxiVdma_SetCallBack_after2\n");
/* Connect interrupt to GIC */
xil_printf("InterruptConnect_before\n");
InterruptConnect(&XScuGicInstance,S2MM_INTID_sobel,XAxiVdma_WriteIntrHandler,(void *)&sobel_vdma);
Status1 = InterruptConnect(&XScuGicInstance,S2MM_INTID_sobel,XAxiVdma_WriteIntrHandler,(void *)&sobel_vdma);
   if(Status1 == XST_FAILURE)
    xil_printf("narges\n2");
xil_printf("InterruptConnect_after\n");
/* enable vdma interrupt */
xil_printf("XAxiVdma_IntrEnable_before\n");
XAxiVdma_IntrEnable(&sobel_vdma, XAXIVDMA_IXR_ALL_MASK, XAXIVDMA_WRITE);
xil_printf("XAxiVdma_IntrEnable_after\n");
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
